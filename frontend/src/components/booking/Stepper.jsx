...
const Stepper = () => {
  ...
  return (
    <div className="w-full py-4 sticky top-0 z-40 bg-white">
      {/* Desktop Stepper */}
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div key={step.id} className="relative flex flex-col items-center flex-1 group">
                ...
                {index !== 0 && (
                  <div className={cn(
                    "absolute left-0 right-1/2 top-5 h-0.5 transition-all duration-500",
                ...
                {index !== steps.length - 1 && (
                  <div className={cn(
                    "absolute left-1/2 right-0 top-5 h-0.5 transition-all duration-500",
                    isCompleted ? "bg-indigo-600" : "bg-slate-200"
                  )} />
                )}
